 ...
 */
 ...
 // Rango de colores
 #define RE_MAX            100  ///< Máximo valor para el canal rojo
 #define RE_MIN            30   ///< Mínimo valor para el canal rojo
 #define GR_MAX            30   ///< Máximo valor para el canal verde
 #define GR_MIN            15   ///< Mínimo valor para el canal verde
 #define BL_MAX            15   ///< Máximo valor para el canal azul
 #define BL_MIN            0    ///< Mínimo valor para el canal azul
  ...
  */
 void uart_process_event ( int uart_num, QueueHandle_t uart_queue );
