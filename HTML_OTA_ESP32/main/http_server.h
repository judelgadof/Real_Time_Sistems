...
extern bool temp_printing_enabled;  // Declaración de la variable global
extern int red_val_http;
extern int green_val_http;
extern int blue_val_http;
extern int on_time_val;
extern int off_time_val;
extern bool use_web_values ;
